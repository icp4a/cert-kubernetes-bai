...
#    kubectl scale --replicas=1 deployment ibm-bai-insights-engine-operator -n $project_name >&3 2>&3
#    if [ $? -eq 0 ]; then
#        sleep 1
#        if [[ -z "$run_mode" ]]; then
#            echo "Done!"
...
#    kubectl scale --replicas=1 deployment ibm-bai-foundation-operator -n $project_name >&3 2>&3
#    if [ $? -eq 0 ]; then
#        sleep 1
#        if [[ -z "$run_mode" ]]; then
#            echo "Done!"
